...
public class Function {
    ...
    private static final String OPEN_WEATHER_MAP_API = "4dbf6525159c768aa865f2c3e42fd61d";
    ...
    public static class placeIdTask extends AsyncTask<String, Void, JSONObject>
    {
        ...
        public AsyncResponse delegate = null;//Интерфейс обратной связи

        public placeIdTask(AsyncResponse asyncResponse)
        {
            delegate = asyncResponse;//Назначение интерфейса обратной связи через конструктор
        }
    ...
    public static JSONObject getWeatherJSON(String lat, String lon){
        try
        {
            ...
            // Это значение будет 404, если запрос не был успешным
